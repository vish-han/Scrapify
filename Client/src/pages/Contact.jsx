                ...
                <div class="max-w-[570px] mb-12 lg:mb-0">
                   ...
                   <div class="flex mb-8 max-w-[370px] w-full">
                      ...
                      <div class="w-full text-center ">
                         <h4 class="font-bold text-dark text-xl mb-1  text-siteBlue">Our Location</h4>
                   ...
                   <div class="flex mb-8 max-w-[370px] w-full">
                      ...
                      <div class="w-full text-center">
                         <h4 class="font-bold text-dark text-xl mb-1 text-siteBlue">Phone Number</h4>
                         <p class="text-base text-body-color text-emerald-400">(+62)81 414 257 9980</p>
                      </div>
                   </div>
                   <div class="flex mb-8 max-w-[370px] w-full">
                      <div
                      ...
                      <div class="w-full text-center">
                         ...
                         <p class="text-base text-emerald-400">info@yourdomain.com</p>
                      </div>
                   </div>
                </div>
             </div>
